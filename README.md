...
**Status:** In progress — Phases 1–6 merged on `master`; Phase 7 (org / project / branch pickers) in PR review. See [`IMPLEMENTATION.md`](./IMPLEMENTATION.md) for the full 12-phase plan and the per-phase status. The README will gain a screenshot, a live demo link, and a feature tour as the v1.0 release lands.
